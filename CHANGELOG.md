...
- Bump `actions/upload-artifact` from 3 to 6 ([#3](https://github.com/MechanicalFlower/python-template/pull/3), [#81](https://github.com/MechanicalFlower/python-template/pull/81))
