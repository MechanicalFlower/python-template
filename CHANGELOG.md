...
- Bump `sigstore/gh-action-sigstore-python` from 2.1.0 to 3.0.1 ([#5](https://github.com/MechanicalFlower/python-template/pull/5), [#25](https://github.com/MechanicalFlower/python-template/pull/25), [#63](https://github.com/MechanicalFlower/python-template/pull/63))
