...
- Bump `sigstore/gh-action-sigstore-python` from 2.1.0 to 3.2.0 ([#5](https://github.com/MechanicalFlower/python-template/pull/5), [#25](https://github.com/MechanicalFlower/python-template/pull/25), [#71](https://github.com/MechanicalFlower/python-template/pull/71), [#79](https://github.com/MechanicalFlower/python-template/pull/79))
